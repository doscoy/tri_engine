...
void Frustum::initializeFrustum(
    ...
    plane_[NEAR] = Plane(near_clip_[2], near_clip_[1], near_clip_[0]);
    plane_[FAR] = Plane(far_clip_[0], far_clip_[1], far_clip_[2]);
    plane_[RIGHT] = Plane(far_clip_[2], far_clip_[1], pos);
    plane_[TOP] = Plane(far_clip_[1], far_clip_[0], pos);
    plane_[LEFT] = Plane(far_clip_[0], far_clip_[3], pos);
    plane_[BOTTOM] = Plane(far_clip_[3], far_clip_[2], pos);
